...
const sliding_attacks: [8][64]u8 = Computing.compute_sliding_attackmasks();
const file_magics: [64]MagicEntry = Computing.compute_file_magics();
const main_magics: [64]MagicEntry = Computing.compute_diagmain_magics();
const anti_magics: [64]MagicEntry = Computing.compute_diaganti_magics();
const pawn_attacks_white: [64]u64 = Computing.compute_pawn_hits_white();
const pawn_attacks_black: [64]u64 = Computing.compute_pawn_hits_black();
const knight_attacks: [64]u64 = Computing.compute_knight_attacks();
const king_attacks: [64]u64 = Computing.compute_king_attacks();
const rank_attacks: [64 * 64]u64 = Computing.compute_rank_attacks();
const file_attacks: [64 * 64]u64 = Computing.compute_file_attacks();
const diag_main_attacks: [64 * 64]u64 = Computing.compute_diagmain_attacks();
const diag_anti_attacks: [64 * 64]u64 = Computing.compute_diaganti_attacks();
...
const Computing = struct {
    ...
    fn compute_file_magics() [64]MagicEntry {
        ...
        var result: [64]MagicEntry = @splat(.empty);

...
fn compute_sliding_attackmasks() [8][64]u8 {
    ...
    // Determine byte-based sliding attack masks, used for the big sliding attack tables.
...
pub fn get_bishop_attacks(sq: Square, occ: u64) u64 {
    return slider_attacks_of(.bishop, sq, occ);
}

pub fn get_rook_attacks(sq: Square, occ: u64) u64 {
    return slider_attacks_of(.rook, sq, occ);
}

pub fn get_queen_attacks(sq: Square, occ: u64) u64 {
    return slider_attacks_of(.queen, sq, occ);
}

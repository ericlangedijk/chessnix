...
pub const Terms = struct {
    ...
    passed_pawn_bonus: [8]ScorePair,
    protected_pawn_bonus: [8]ScorePair,
    doubled_pawn_penalty: [8]ScorePair,
    isolated_pawn_penalty: [8]ScorePair,
    king_cannot_reach_passed_pawn_bonus: ScorePair,
    bishop_pair_bonus: ScorePair,
    tempo_bonus: ScorePair,
    knight_mobility_table: [9]ScorePair,
    bishop_mobility_table: [14]ScorePair,
    ...
    bishop_pawns: [17]ScorePair,
    rook_on_file_bonus: [2][8]ScorePair,
    pawn_protection_table: [12]ScorePair,
    pawn_storm_table: [21]ScorePair,
    king_on_file_penalty: [2][8]ScorePair,
    threatened_by_pawn_penalty: [6][2]ScorePair,
...
pub const default_terms: Terms = .{
    ...
    .king_cannot_reach_passed_pawn_bonus = pair(-344, 199),

    .bishop_pair_bonus = pair(18, 58),

    .tempo_bonus = pair(30, 27),

    .knight_mobility_table = .{
        pair(-25, 8), pair(-11, 4), pair(-2, 24), pair(3, 33), pair(7, 39), pair(11, 47), pair(16, 46), pair(19, 44), pair(21, 37),
    },

    .bishop_mobility_table = .{
    ...
    .bishop_pawns = .{
        pair(-8, -16), pair(-7, -14), pair(-6, -12), pair(-5, -10), pair(-4, -8), pair(-3, -6), pair(-2, -4), pair(-1, -2), // -8...-1
        pair(0, 0), // 0
        pair(1, 2), pair(2, 4), pair(3, 6), pair(4, 8), pair(5, 10), pair(6, 12), pair(7, 14), pair(8, 16), // 1...8
    },

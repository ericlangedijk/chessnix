...
comptime {
    if (@bitSizeOf(Square) != 6) @compileError("Square");
    if (@bitSizeOf(PieceType) != 4) @compileError("PieceType");
    if (@bitSizeOf(Piece) != 4) @compileError("Piece");
    if (@bitSizeOf(Move) != 16) @compileError("Move");
    if (@bitSizeOf(ExtMove) != 64) @compileError("ExtMove");
}

...
## Version 1.4
- Compiler: Zig 0.15.2.
- Stronger: ~3351 ELO (blitz ~3382) on first CCRL entry.
...
- [Jonathan Hallström](https://github.com/JonathanHallstrom/) for support, advise, brainstorming, io, viriformat, alpha raise reduction, SEE comptime mode.
